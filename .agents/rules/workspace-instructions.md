...
* **ล่าสุดทำอะไรเสร็จไปแล้ว:**
  ...
  * [x] สร้าง DTOs และระบบ TokenService (ITokenService, TokenService) เพื่อใช้ในกระบวนการออกต๋ว JWT เรียบร้อย
  * [x] สร้าง `AuthController.cs` สำหรับ API `/api/auth/login` เพื่อออกตั๋ว JWT เรียบร้อย
* **เป้าหมายสเต็ปถัดไป:**
  * [ ] พัฒนาระบบ Product & Category CRUD API (สร้าง DTOs, Controllers และจำกัดสิทธิ์ด้วย JWT)
