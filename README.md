...
โปรเจกต์หลังบ้านมีการเขียนชุดทดสอบยูนิตเทส (Unit Tests) ครอบคลุมการทำงานของ Service Layer ทั้งหมด 22 เคส โดยสามารถรันการทดสอบได้ 2 รูปแบบดังนี้:

1. **การรันผ่าน Command Line:** เปิด Terminal ที่โฟลเดอร์หลักของโปรเจกต์ (Root Directory) แล้วรันคำสั่ง:
   ```bash
   dotnet test
   ```
2. **การรันผ่าน Visual Studio:** เปิดหน้าต่าง **Test Explorer** (เมนู *Test* -> *Test Explorer*) จากนั้นคลิกปุ่ม **Run All** เพื่อดูผลลัพธ์การทดสอบ
